...
export const developers = [
  { id: 'dev1', name: 'Amit Verma', bio: 'MERN stack developer who loves building payment-heavy backends.' },
  { id: 'dev2', name: 'Priya Nair', bio: 'Frontend engineer focused on design systems and accessibility.' },
  { id: 'dev3', name: 'Rahul Mehta', bio: 'Backend engineer, deep into distributed systems and Go.' },
  { id: 'dev4', name: 'Sneha Kulkarni', bio: 'Full-stack developer, recently picked up GraphQL and Next.js.' },
  { id: 'dev5', name: 'Arjun Malhotra', bio: 'DevOps engineer, Kubernetes and CI/CD pipelines.' },
  { id: 'dev6', name: 'Fatima Sheikh', bio: 'ML engineer working on recommendation systems.' },
  { id: 'dev7', name: 'Karan Desai', bio: 'Junior developer, strong in React, learning backend fundamentals.' },
  { id: 'dev8', name: 'Neha Joshi', bio: 'Database specialist, PostgreSQL and query optimization.' },
  { id: 'dev9', name: 'Vikram Rao', bio: 'Security-focused backend engineer, JWT/OAuth expert.' },
  { id: 'dev10', name: 'Ananya Iyer', bio: 'Product-minded full-stack developer, UX + Tailwind.' },
];
...
export const projects = [
  { id: 'proj1', name: 'PayFlow', description: 'Payment gateway integration service for e-commerce checkout.' },
  { id: 'proj2', name: 'DesignKit', description: 'Internal design system and component library.' },
  { id: 'proj3', name: 'Orion', description: 'Distributed order-processing microservice.' },
  { id: 'proj4', name: 'RecoEngine', description: 'Recommendation engine for a content platform.' },
  { id: 'proj5', name: 'DeployHub', description: 'Internal CI/CD and Kubernetes deployment tooling.' },
  { id: 'proj6', name: 'QueryOpt', description: 'Query optimization and analytics dashboard for Postgres.' },
];
